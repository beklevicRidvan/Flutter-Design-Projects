...
class AnaSayfa extends StatelessWidget {
  ...
  Widget burcListesiOlustur(BuildContext context, int index,String sayfaAdi) {
    return Card(
      child: ListTile(
        onTap: () {

          SayfayaGit(context,sayfaAdi);
        },
        title: Text(
  ...
  void SayfayaGit(BuildContext context,String sayfaAdi){
    Navigator.pushNamed(context, sayfaAdi);
  }
